...
from HotpotQA.state.hotpotqa import StateHotpotQA
from HotpotQA.typedefs import Environment, MAX_SEED, Model, DecodingParameters
...
class EnvironmentHotpotQA(Environment):
    ...
    @staticmethod
    def value_prompt_wrap(model: Model,state: StateHotpotQA,n: int, params: DecodingParameters,cache: dict=None) -> str:
        pass
